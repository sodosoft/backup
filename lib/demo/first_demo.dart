...
class _MyAppState extends State<firstDemo> {
                              ...
                              onTap: () {
                                if (LoginScreen.paymentYN == 'Y') {
                                  ...
                                  Fluttertoast.showToast(
                                      msg: '데모 화면입니다. 결제 후 이용 부탁 드리겠습니다.');
                                }
                              },
                            ),
                          );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          if (LoginScreen.paymentYN == 'Y') {
            ...
            Fluttertoast.showToast(msg: '데모 화면입니다. 결제 후 이용 부탁 드리겠습니다.');
          }
        },
