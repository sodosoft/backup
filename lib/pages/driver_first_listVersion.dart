...
import 'package:bangtong/test/driver_first_listVersion.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class Driver_first_list extends StatefulWidget {
  const Driver_first_list({Key? key}) : super(key: key);

  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<Driver_first_list> {
  String strDday = '';
  String strNextDday = '';
      ...
      body: Column(
        children: [
          ...
          SizedBox(
              width: double.infinity,
              child: InkWell(
                  child: Image.asset('assets/images/main1.jpg', height: 175),
                  onTap: () {
                    //상차지 기준
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Driver_order()));
                  })),
          SizedBox(
              width: double.infinity,
              child: InkWell(
                  child: Image.asset('assets/images/main2.jpg', height: 175),
                  onTap: () {
                    // // 하차지 기준
          ...
          SizedBox(
              width: double.infinity,
              child: InkWell(
                  child: Image.asset('assets/images/main3.jpg', height: 175),
                  onTap: () {
                    //제강사 기준
                    // Navigator.push(context,
